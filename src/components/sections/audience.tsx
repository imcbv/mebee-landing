        ...
        >
          ...
          >
            ...
            <motion.p
              ...
              viewport={{ once: true }}
            >
              Built for teams that need to move fast across markets
            </motion.p>
          </motion.div>
          ...
          >
              ...
              <div className="space-y-3 relative z-10">
                {COPY.audience.internalTeams.teams.map((team, index) => (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                  >
                    <span className="text-base text-mebee-dark-navy font-medium">
                      {team}
                    </span>
                  </motion.div>
                ))}
            ...
            >
              ...
              <div className="space-y-3 relative z-10">
                {COPY.audience.externalNetworks.networks.map(
                  (network, index) => (
                    <motion.div
                      key={index}
                      className="flex items-center justify-start bg-mebee-sage/10 p-3 border-l-4 border-mebee-dark-navy hover:bg-mebee-sage/20 transition-colors duration-200"
